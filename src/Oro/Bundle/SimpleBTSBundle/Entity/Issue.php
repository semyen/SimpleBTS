...
use Oro\Bundle\SimpleBTSBundle\Model\ExtendIssue;
 ...
 * Issue
 *
 * @ORM\Table(name="oro_sbts_issue")
 * @ORM\Entity(repositoryClass="Oro\Bundle\SimpleBTSBundle\Entity\Repository\IssueRepository")
 * @Config(
 *      defaultValues={
 *          "entity"={
 *              "icon"="icon-list-alt"
...
class Issue extends ExtendIssue
{
     ...
     * @ORM\JoinTable(name="oro_sbts_issue_relation",
     ...
     * @ORM\JoinTable(name="oro_sbts_issue_collaborators",
